(()=>{
  ...
  function loadHotfixes(){
    loadScript('./drawing-manager-v1024.js?v=10.25.12','drawing-manager-v1024.js?v=10.25.12');
    loadScript('./drawing-delete-page-v1024.js?v=10.25.12','drawing-delete-page-v1024.js?v=10.25.12');
    loadScript('./caisson-final-workbook-import-v10253.js?v=10.25.12','caisson-final-workbook-import-v10253.js?v=10.25.12');
    loadScript('./poured-status-v10254.js?v=10.25.12','poured-status-v10254.js?v=10.25.12');
    loadScript('./inspection-status-fix-v10257.js?v=10.25.12','inspection-status-fix-v10257.js?v=10.25.12');
    loadScript('./ers-readable-numbers-v102512.js?v=10.25.12','ers-readable-numbers-v102512.js?v=10.25.12');
  }
  apply();loadHotfixes();
