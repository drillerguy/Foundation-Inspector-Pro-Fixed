(()=>{
  ...
  function loadScript(file){
    ...
    const s=document.createElement('script');s.src=`./${file}?v=${BUILD}`;s.async=false;s.dataset.fieldverifyHotfix=file;s.onerror=()=>console.error('FieldVerify hotfix failed to load: '+file);document.body.appendChild(s);
  }
  ...
  apply();setTimeout(loadHotfixes,0);setTimeout(apply,300);
})();
