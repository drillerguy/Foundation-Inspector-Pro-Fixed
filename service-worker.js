...
async function patchHtml(response){
  ...
  const tags=[
    ...
    '<script src="./drawing-manager-v1024.js?v=10.24.1"></script>',
  ...
  for(const tag of tags){
    ...
    const requestedVersion=(file==='office-report-split-v103.js'||file==='drawing-manager-v1024.js')?'10.24.1':'10.24';
