(()=>{
  ...
  function loadHotfixes(){
    ...
    for(const file of files)loadScript(`./${file}?v=${BUILD}`,`${file}?v=${BUILD}`);
  }
  ...
  apply();loadHotfixes();stabilizeWorker();
  setTimeout(apply,250);setTimeout(loadHotfixes,600);setTimeout(stabilizeWorker,1200);
})();