(()=>{
  ...
  function loadHotfixes(){
    loadScript('./drawing-manager-v1024.js?v=10.25.13','drawing-manager-v1024.js?v=10.25.13');
    loadScript('./drawing-delete-page-v1024.js?v=10.25.13','drawing-delete-page-v1024.js?v=10.25.13');
    loadScript('./caisson-final-workbook-import-v10253.js?v=10.25.13','caisson-final-workbook-import-v10253.js?v=10.25.13');
    loadScript('./poured-status-v10254.js?v=10.25.13','poured-status-v10254.js?v=10.25.13');
    loadScript('./inspection-status-fix-v10257.js?v=10.25.13','inspection-status-fix-v10257.js?v=10.25.13');
    loadScript('./ers-readable-numbers-v102512.js?v=10.25.13','ers-readable-numbers-v102512.js?v=10.25.13');
  }
  apply();loadHotfixes();
