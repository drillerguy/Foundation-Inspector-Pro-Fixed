...
self.addEventListener('fetch',event=>{
  ...
  if(/\/(backup-zip-v10|ncr-data-guard-v1012|ncr-preload|ncr-ui-patch|ncr-import-fix-v108|ncr-engineer-fix-v109|ncr-full-window-v1011|pdf-backup-v1014|pdf-photo-fix-v1019|photo-integrity-v1021|photo-recovery-import-v1023|cloud-sync-v1024|cloud-auth-fix-v1025|cloud-access-v1026|photo-viewer-v1027|update-refresh-v1017|version-lock-v1024)\.js$/.test(url.pathname)){
